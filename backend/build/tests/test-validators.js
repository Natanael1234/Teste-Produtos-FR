...
exports.validaEstruturaPedido = exports.validaEstruturaCarrinho = exports.validaComparacaoProdutos = exports.validaEstruturaProduto = void 0;
/**
 ...
 */
function validaEstruturaProduto(produto) {
    // id
...
exports.validaEstruturaProduto = validaEstruturaProduto;
/**
 ...
 */
function validaComparacaoProdutos(produtoNaoSalvo, produtoSalvo) {
    ...
    if (!produtoNaoSalvo.tags) { // se não recebeu o array de tags: 
        ...
        produtoSalvo.tags.map((tag1) => {
            let tag2 = produtoNaoSalvo.tags.map((tag2) => tag1.id == tag2.id && tag1.name == tag2.name);
            expect(tag2).toBeTruthy();
        });
    }
}
exports.validaComparacaoProdutos = validaComparacaoProdutos;
/**
 * Verifica se os dados de um carrinho estão estruturalmente corretos.
 * @param carrinho dados do carrinho a serer validados.
 */
function validaEstruturaCarrinho(carrinho) {
...
exports.validaEstruturaPedido = validaEstruturaPedido;
//# sourceMappingURL=test-validators.js.map